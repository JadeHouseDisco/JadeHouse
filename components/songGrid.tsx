          ...
          <div className="flex items-center justify-between mt-8">
            <div>
              <button
                ...
                className="bg-gray-50 text-gray-900 hover:bg-[#00a896] focus:ring-gray-300 transition-colors duration-300 ease-in-out py-2 px-4 rounded-full mr-4"
              >
              ...
              <button
                onClick={handleNext}
                className="bg-gray-50 text-gray-900 hover:bg-[#00a896] focus:ring-gray-300 transition-colors duration-300 ease-in-out py-2 px-4 rounded-full"
              >
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="black">
              ...
              {songGridProps.map((_, index) => (
                <div
                  ...
                  className={`w-3 h-3 rounded-full mx-1 ${
                    index === currentSong ? 'bg-teal-500' : 'bg-gray-600'
                  }`}
                ></div>
              ))}
            </div>
