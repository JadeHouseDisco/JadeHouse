              ...
              <div className="prose prose-lg mx-auto max-w-3xl mb-12 blog-content">
                  ...
                  <div className="mt-4">
                    <a
                      ...
                      target="_blank"
                      href="https://docs.google.com/presentation/d/1CjBesglQUwZnhki5tLUgUUuSTRXciWQK/edit?usp=drive_link&ouid=108511981520130649220&rtpof=true&sd=true"
                    >
                    ...
                    <a
                      className="inline-flex items-center mr-4 justify-center h-10 px-4 rounded-md focus:outline-none focus:ring-2 bg-gray-50 text-gray-900 hover:bg-[#00a896] focus:ring-gray-300 transition-colors duration-300 ease-in-out"
                      target="_blank"
                      href="https://drive.google.com/file/d/1RsxoBgJg6-gLz-FnRtr-fZh3Do5aYGzR/view?usp=drive_link"
                    >
                      <DownloadIcon className="mr-2 h-5 w-5" />
                      Code
                    </a>
                    <a
                      className="inline-flex items-center mr-4 justify-center h-10 px-4 rounded-md focus:outline-none focus:ring-2 bg-gray-50 text-gray-900 hover:bg-[#00a896] focus:ring-gray-300 transition-colors duration-300 ease-in-out"
                      target="blank"
                      href="https://drive.google.com/file/d/1RSk1XNbRtfBdSatZIEhcK1TD3Ut_HOBy/view?usp=drive_link"
                    >
                      <DownloadIcon className="mr-2 h-5 w-5" />
                      Demo Videos
                    </a>
