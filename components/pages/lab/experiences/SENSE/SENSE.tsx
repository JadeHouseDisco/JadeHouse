            ...
            <div className="relative flex">
              ...
              <div className="prose prose-lg mx-auto max-w-3xl mb-12 blog-content">
                  ...
                  <ol className="list-decimal my-1 pl-8">
                      ...
                      <li className="max-w-3xl text-base md:text-lg">
                        Diagnosing disc herniation through binary classification
                      </li>
                  </ol>
                  <p className="mt-4 max-w-3xl text-base md:text-lg">
                  ...
                  <ul className="list-decimal my-1 pl-8">
                      ...
                      <li className="max-w-3xl text-base md:text-lg">
                        <strong>Dr. Lim Zhi Jun</strong>: PhD Candidate, Nanyang Technological University
                      </li>
                  </ul>
                  ...
                  <div className="relative">
                    <Image
                      ...
                      src="https://github.com/JadeHouseDisco/JadeHouse_Files/blob/main/blogPosts/SENSE/4.png?raw=true"
                      height="800"
                      width="1600"
                    />
                  </div>
                  ...
                  <ul className="list-decimal my-1 pl-8">
                      ...
                      <li className="max-w-3xl text-base md:text-lg">
                        Successful static environment proof of concept
                      </li>
                      <li className="max-w-3xl text-base md:text-lg">
                        Formulation of a problem statement and business model
                      </li>
                  </ul>
                  <p className="mt-4 max-w-3xl text-base md:text-lg">
                    For more details, refer to our <a className = "text-blue-500 text-under underline" target="_blank" href="https://docs.google.com/spreadsheets/d/1W0Z6j0c1Yzrwr__9PT0DGzZu3szxcANzaVkKT0paPg0/edit?usp=sharing">meeting and progress records</a>.
                  </p>
                  ...
                  <ul className="list-disc my-1 pl-8">
                      <li className="max-w-3xl text-base md:text-lg">
                        inalizing pitch and technical presentations
                      </li>
                      <li className="max-w-3xl text-base md:text-lg">
                        Preparing for and conducting market research interviews
                      </li>
                      <li className="max-w-3xl text-base md:text-lg">
                        Creating a market research survey
                      </li>
                      <li className="max-w-3xl text-base md:text-lg">
                        Competing for NTU’s Entrepreneurship & Startup Training seed fund
                      </li>
                      <li className="max-w-3xl text-base md:text-lg">
                  ...
                  <ul className="list-disc my-1 pl-8">
                      <li className="max-w-3xl text-base md:text-lg">
                        Conduct at least 20 market research interviews
                      </li>
                      <li className="max-w-3xl text-base md:text-lg">
                  ...
                  <div className="mt-4">
                    <a
                      ...
                      target="_blank"
                      href="https://github.com/JadeHouseDisco/JadeHouse_Files/blob/main/files/blogposts/SENSE/pitch.pptx?raw=true"
                    >
                    ...
                    <a
                      className="inline-flex items-center mr-4 justify-center h-10 px-4 rounded-md focus:outline-none focus:ring-2 bg-gray-50 text-gray-900 hover:bg-[#00a896] focus:ring-gray-300 transition-colors duration-300 ease-in-out"
                      target="_blank"
                      href="https://github.com/JadeHouseDisco/JadeHouse_Files/blob/main/files/blogposts/SENSE/technical_pitch.pptx?raw=true"
                    >
                      <DownloadIcon className="mr-2 h-5 w-5" />
                      Technical Pitch
                    </a>
                    <a
                      className="inline-flex items-center mr-4 justify-center h-10 px-4 rounded-md focus:outline-none focus:ring-2 bg-gray-50 text-gray-900 hover:bg-[#00a896] focus:ring-gray-300 transition-colors duration-300 ease-in-out"
                      target="blank"
                      href="https://github.com/JadeHouseDisco/JadeHouse_Files/blob/main/files/blogposts/SENSE/code.zip?raw=true"
                    >
                      <DownloadIcon className="mr-2 h-5 w-5" />
                      Code
                    </a>
