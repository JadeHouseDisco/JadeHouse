              ...
              <div className="blog-content prose prose-lg mx-auto mb-12 flex-1">
                  ...
                  <div className="mt-4">
                    <a
                      ...
                      target="_blank"
                      href="https://docs.google.com/presentation/d/1ZERuCPIxLyLmvi1KaN0sbyaKc3WT--d7/edit?usp=drive_link&ouid=108511981520130649220&rtpof=true&sd=true" rel="noreferrer"
                    >
                    ...
                    <a
                      className="inline-flex items-center mr-4 justify-center h-10 px-4 rounded-md focus:outline-none focus:ring-2 bg-gray-50 text-gray-900 hover:bg-[#00a896] focus:ring-gray-300 transition-colors duration-300 ease-in-out"
                      target="_blank"
                      href="https://drive.google.com/file/d/1Fujhzo4nTwbvvHUjVAJmtbL93o3ktdzN/view?usp=drive_link" rel="noreferrer"
                    >
                      <DownloadIcon className="mr-2 h-5 w-5" />
                      STEP Files
                    </a>
                    <a
                      className="inline-flex items-center mr-4 justify-center h-10 px-4 rounded-md focus:outline-none focus:ring-2 bg-gray-50 text-gray-900 hover:bg-[#00a896] focus:ring-gray-300 transition-colors duration-300 ease-in-out"
                      target="_blank"
                      href="https://drive.google.com/file/d/105N-nsW90n4B-ZmMh1t4M3ERxH7XBj-D/view?usp=drive_link" rel="noreferrer"
                    >
                      <DownloadIcon className="mr-2 h-5 w-5" />
                      Demo Videos
                    </a>
