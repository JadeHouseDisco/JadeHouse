            ...
            <div className="relative flex">
              ...
              <div className="prose prose-lg mx-auto max-w-3xl mb-12 blog-content">
                ...
                <p className="my-4 max-w-3xl text-base md:text-lg">
                  Mai, Ramadan, Ibraheem. (2023). Lower Limb Analysis Based on Surface Electromyography (sEMG) Using Different Time-frequency Representation Techniques. International Journal on Advanced Science, Engineering and Information Technology, 13(1):24-24. doi: 10.18517/ijaseit.13.1.16685 [<a className="text-blue-500 text-under underline" target="_blank" href="https://ijaseit.insightsociety.org/index.php/ijaseit/article/view/16685">Link to paper</a>]
                </p>
