...
function YoutubeMusicIcon(props: IconProps) {
  return (
    <svg
      {...props}
      fill="white"
...
function YoutubeMusicIcon_black(props: IconProps) {
  return (
    <svg
      {...props}
      fill="black"
...
export { GithubIcon, InstagramIcon, LinkedinIcon, MailIcon, TwitterIcon, YoutubeIcon, GoogleScholarIcon, ORCIDIcon, GraduationCapIcon, TrophyIcon, DownloadIcon, DockerIcon, ROSIcon, HTMLIcon, CssIcon, JavascriptIcon, CubeIcon, MeshIcon, ReactIcon, CppIcon, PythonIcon, GitIcon, PlayIcon, YoutubeMusicIcon, YoutubeMusicIcon_black };