...
const MiniAbout: React.FC<MiniAboutProps> = ({ miniAboutProps }) => {
  return (
    <React.Fragment>
        ...
        <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="flex items-center justify-center">
            <Image
              ...
              width={miniAboutProps.profileImage.width}
            />
          </div>
          <div className="space-y-4">
            <h2 className="text-3xl font-bold">{miniAboutProps.name}</h2>
            <p className="text-gray-400">{miniAboutProps.bio}</p>
            <div className="flex space-x-4">
              {miniAboutProps.socialLinks.map((link, index) => (
                <a
                  key={index}
            ...
            <Link
                ...
                href={miniAboutProps.button.href}
            >
              {miniAboutProps.button.text}
            </Link> : null }
          </div>
