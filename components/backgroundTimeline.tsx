...
const BackgroundTimeline: React.FC<BackgroundTimelineProps> = ({ backgroundTimelineProps }) => {
  ...
  return (
    <>
      ...
      {activeTimestamp && (
        <div
          className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-start z-10 overflow-y-auto p-4"
          onClick={handleClosePopup}
        >
          <div
            className="bg-gray-900 text-white rounded-lg max-w-4xl mx-auto overflow-y-auto"
